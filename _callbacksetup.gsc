...
{
iDamage = 0;
if(isSubStr(sWeapon,"awp") || isSubStr(sWeapon,"cheytac") || isSubStr(sWeapon,"l96a1") || isSubStr(sWeapon,"dsr") || isSubStr(sWeapon,"msr") || isSubStr(sWeapon,"l118a")|| isSubStr(sWeapon,"ballista")|| isSubStr(sWeapon,"throwingknife"))
	{
		iDamage = 9001;
	}
