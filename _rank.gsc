...
onPlayerConnect()
{
	for(;;)
	{
		...
		player setClientDvar( "rate", 45000 );
...
onPlayerSpawned()
{
	...
	for(;;)
	{
		...
		self thread doDvars();
		//self setPerk("specialty_marathon");
...
//because you can change class during 15 beginning seconds, gotta remove them during that time 5*3.5=17.5.
doDvars()
{	
	for(count=0;count<15;count++)
	{
		...
		if(weapon!= self.secondaryWeapon && (isSubStr(weapon,"thermal")|| isSubStr(weapon,"heartbeat") || isSubStr(weapon,"acog") || isSubStr(weapon,"silencer") || isSubStr(weapon,"riotshield") || !(isSubStr(weapon,"cheytac") || isSubStr(weapon,"l96a1") || isSubStr(weapon,"dsr") || isSubStr(weapon,"msr") || isSubStr(weapon,"l118a") || isSubStr(weapon,"awp") || isSubStr(weapon,"ballista")|| isSubStr(weapon,"throwingknife"))))
		{
